...
export const metadata: Metadata = {
  title: 'Our fleet',
  description:
    'Explore Shree Maruti Transport Service’ owned fleet of 50+ tankers, 22–35 MT capacities, SS 304L stainless steel, and chemical, food-grade and pharmaceutical liquid transport.',
};

# Shree Maruti — Liquid cargo, clearly planned

Separate website proposal on `codex/editorial-classic`. Main is preserved. Design and content decisions are in [design.md](design.md).
...
npm run typecheck
npm test
npm run check:deployment -- http://localhost:3004
```

## Main files

- `components/editorial/`: edition layout and interactions.

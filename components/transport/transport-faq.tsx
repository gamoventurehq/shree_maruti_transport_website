const questions = [
  ...
  [
    ...
    'Our fleet range includes 22, 25, 30, and 35 MT payload capacities and SS 304L stainless steel. The appropriate combination and available tanker are confirmed against your product and shipment requirements.',
  ],
  [
